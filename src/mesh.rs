...
const COLORED_MESH2D_SHADER: &str = include_str!("../assets/shaders/instancing.wgsl");
...
impl Plugin for ColoredMesh2dPlugin {
    fn build(&self, app: &mut App) {
        ...
        shaders.set_untracked(COLORED_MESH2D_SHADER_HANDLE, Shader::from_wgsl(COLORED_MESH2D_SHADER));
